    ...
    *,
    ...
    metadata = _study_metadata(
        ...
        config={
            ...
            "rolling_window_depth": rolling_window_depth, "rolling_frontier_width": rolling_frontier_width,
            "max_rolling_windows": max_rolling_windows,
            "beam_width": beam_width, "max_states": max_states,
...
def _summary_metadata(study_dir: Path) -> dict:
    ...
    return {
        ...
        "rolling_window_depth": first.get("rolling_window_depth", ""),
        "rolling_frontier_width": first.get("rolling_frontier_width", ""),
        "max_rolling_windows": first.get("max_rolling_windows", ""),
        "rolling_windows_completed": first.get("rolling_windows_completed", ""),
        "rolling_committed_depth": first.get("rolling_committed_depth", ""),
        "rolling_closure_reason": first.get("rolling_closure_reason", ""),
        "rolling_frontier_pruned": first.get("rolling_frontier_pruned", ""),
        "rolling_frontier_states_pruned": first.get("rolling_frontier_states_pruned", ""),
        "global_search_complete": first.get("global_search_complete", ""),
